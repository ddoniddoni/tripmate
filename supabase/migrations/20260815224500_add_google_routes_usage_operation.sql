...
check (operation in ('places_text_search', 'maps_javascript_load', 'routes_compute'));
...
begin
  if p_operation not in ('places_text_search', 'maps_javascript_load', 'routes_compute') then
